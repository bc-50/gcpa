...
<div class="order-list">
  <?php if ( $has_orders ) : ?>
        ...
        <div id="orders" class="carousel slide" data-ride="carousel" data-interval="false">
        ...
        foreach ( $customer_orders->orders as $customer_order ) {
          ...
          ?>
          <div class="carousel-item<?php echo $first ? ' active' : '' ?> order-item">
          ...
          <ul class="woocommerce-orders-table__row woocommerce-orders-table__row--status-<?php echo esc_attr( $order->get_status() ); ?> order">
            <?php foreach ( wc_get_account_orders_columns() as $column_id => $column_name ) : ?>
              <label><?php echo esc_attr( $column_name ); ?></label>
                  ...
                  if ( ! empty( $actions ) ) {
                    foreach ( $actions as $key => $action ) { // phpcs:ignore WordPress.WP.GlobalVariablesOverride.OverrideProhibited ?> 
                      <div class="button-wrapper">
                        <?php echo '<a href="' . esc_url( $action['url'] ) . '" class="woocommerce-button button ' . sanitize_html_class( $key ) . '">' . esc_html( $action['name'] ) . '</a>'; ?>
                      </div>
                    <?php }
                  }
                  ?>

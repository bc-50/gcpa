    ...
    <div class="container">
      <?php foreach ($rows as $row) { ?>
        ...
        <div class="row justify-content-between grid-row">
          <div class="col-md-6">
            <a href="<?php echo $b_link ?>" <?php echo $b_target ?> class="grid-wrapper" style="background-image: url(<?php echo isset($row['limg']) ? wp_get_attachment_image_src($row['limg'], 'full')[0] : ''; ?>)">
            </a>
          </div>
          <div class="col-md-6">
            <a href="<?php echo $a_link ?>" <?php echo $a_target ?> class="grid-wrapper" style="background-image: url(<?php echo isset($row['rimg']) ? wp_get_attachment_image_src($row['rimg'], 'full')[0] : ''; ?>)">
            </a>
          </div>
        </div>
      <?php } ?>

...
Template Post Type: sponsors,page,approved,post
*/ ?>
      ...
      <div class="col-lg-3">
        <section class="menu-single">
          <ul>
            ...
            <?php } elseif($ptype == 'post') { ?>
              <li><a href="<?php echo esc_url(site_url()); ?>">Other News</a></li>
            <?php } else { ?>
        ...
        <section class="sponsor-content">
          <div class="inner-wrapper">
                <div class="title-wrapper">
                  <h2><?php echo has_excerpt() ? get_the_excerpt() : get_the_title() ?></h2>
                </div>
            <?php 
            if (has_post_thumbnail()) { ?>
              <div class="image-wrapper">
                <a href="<?php echo get_field('link') ? get_field('link') : '#' ?>"  target="_blank"><img src="<?php echo get_the_post_thumbnail_url() ?>" alt="<?php echo get_the_title() ?> Logo"></a>
              </div>
            <?php } ?>
